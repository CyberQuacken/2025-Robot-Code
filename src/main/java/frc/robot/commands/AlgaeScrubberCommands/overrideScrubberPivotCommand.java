...
public class overrideScrubberPivotCommand extends Command {
    private final AlgaeScrubberPivotSubsytem m_Subsystem;

    public overrideScrubberPivotCommand(AlgaeScrubberPivotSubsytem subsystem){
