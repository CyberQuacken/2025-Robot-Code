...
public class pivotCoralClawDeployCommand extends Command{
    /**
     * <The default command>
    ...
    public pivotCoralClawDeployCommand(CoralClawPivotSubsystem subsystem){
    ...
    public void initialize(){
        ...
        m_coralClawPivotSubsystem.setCurrentPosition(coralClawConstants.depositPositionIndex);
    }
